...
//#if defined(__XC8)
        ...
        #define IN_DATA_BUFFER_ADDRESS_TAG  __at(IN_DATA_BUFFER_ADDRESS)
        #define OUT_DATA_BUFFER_ADDRESS_TAG __at(OUT_DATA_BUFFER_ADDRESS)
        #define LINE_CODING_ADDRESS_TAG     __at(LINE_CODING_ADDRESS)
        #define NOTICE_ADDRESS_TAG          __at(NOTICE_ADDRESS)
    #else
